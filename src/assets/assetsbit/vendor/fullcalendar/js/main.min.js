...
var FullCalendar = function(e) {
    ...
    var na = function(e) {
        ...
        t.prototype.render = function() {
            for (var e, t = this.props, n = this.state, r = this.context, i = t.sections || [], a = this.processCols(t.cols), s = this.renderMicroColGroup(a, n.shrinkWidth), l = Ji(t.liquid, r), u = i.length, c = 0, d = [], p = [], f = []; c < u && "header" === (e = i[c]).type; )
                d.push(this.renderSection(e, s)),
                c += 1;
            for (; c < u && "body" === (e = i[c]).type; )
                p.push(this.renderSection(e, s)),
                c += 1;
            for (; c < u && "footer" === (e = i[c]).type; )
                f.push(this.renderSection(e, s)),
                c += 1;
            var h = !pr();
            return Ar("table", {
                className: l.join(" "),
    ...
    var ks = function() {
        ...
        e.prototype.computeTimeTop = function(e) {
            var t, n, r = this.positions, o = this.dateProfile, i = r.els.length, a = (e.milliseconds - et(o.slotMinTime)) / et(this.slotDuration);
      ...
      , xs = function(e) {
        ...
        t.prototype.updateSizing = function() {
            ...
            n.onCoords && null !== n.clientWidth && (this.rootElRef.current.offsetHeight && n.onCoords(new ks(new _r(this.rootElRef.current,(e = this.slatElRefs.currentMap,
